  ...
  return (
    <div className="min-h-screen" style={{ background: "#0f1117" }}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(85,96,248,0.08) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="max-w-full px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs truncate" style={{ color: "#5a607a" }}>
                {projeto.produto} · {projeto.cliente}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex h-[calc(100vh-57px)]">
        {/* Sidebar tabs */}
        <aside
          className="w-56 flex-shrink-0 border-r overflow-y-auto hidden md:block"
            ...
            {ABAS.map((aba) => {
              ...
              return (
                <button
                  ...
                  style={isActive ? {
                    color: "#e8eaf0",
                    background: "rgba(85,96,248,0.15)",
                    border: "1px solid rgba(85,96,248,0.25)",
                  } : {}}
        ...
        {/* Mobile tab bar */}
        <div
          className="md:hidden fixed bottom-0 left-0 right-0 z-30 overflow-x-auto border-t"
          style={{
            ...
            {ABAS.map((aba) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isActive ? "rgba(85,96,248,0.15)" : "transparent",
                    color: isActive ? "#7585fd" : "#5a607a",
                  }}
                >
                  <Icon size={14} />
        ...
        <main className="flex-1 overflow-y-auto pb-20 md:pb-6">
          <div className="max-w-5xl mx-auto p-6">
            ...
            {/* Placeholder content */}
            <div
              className="glass rounded-2xl p-12 flex flex-col items-center justify-center text-center animate-fadeIn"
              style={{ animationDelay: "0.1s", minHeight: "320px" }}
            >
              <div
                className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4"
                style={{ background: "rgba(85,96,248,0.1)", border: "1px solid rgba(85,96,248,0.15)" }}
              >
                <AbaIcon size={28} style={{ color: "#5560f8", opacity: 0.7 }} />
              </div>
              <h3
                className="text-base font-medium mb-2"
                style={{ fontFamily: "var(--font-sora)", color: "#8890a8" }}
              >
                {abaAtivaObj.label}
              </h3>
              <p className="text-sm max-w-xs" style={{ color: "#5a607a" }}>
                Esta seção será configurada em breve. Os campos e funcionalidades serão adicionados conforme o projeto avança.
              </p>
            </div>
          </div>
        </main>
